...
def create_adk_agent_handler(name: str, model: str, tools: List[str] = None, system_prompt: str = "") -> Dict[str, Any]:
    """
...
def create_crewai_team_handler(team_name: str, agents: List[Dict], tasks: List[Dict]) -> Dict[str, Any]:
    """
...
def create_a2a_agent_handler(agent_name: str, protocol_version: str, endpoints: List[str] = None) -> Dict[str, Any]:
    """
...
def create_langbase_agent_handler(agent_name: str, memory_type: str, documents: List[str] = None) -> Dict[str, Any]:
    """
...
def create_agui_agent_handler(agent_name: str, ui_components: List[str], theme: str = "soft") -> Dict[str, Any]:
    """
